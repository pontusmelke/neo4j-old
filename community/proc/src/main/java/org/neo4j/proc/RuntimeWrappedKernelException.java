 ...
 * as a vessel.
 */
public class RuntimeWrappedKernelException extends RuntimeException implements Status.HasStatus
{
    private final KernelException wrappee;

    public RuntimeWrappedKernelException( KernelException wrappee )
    {
