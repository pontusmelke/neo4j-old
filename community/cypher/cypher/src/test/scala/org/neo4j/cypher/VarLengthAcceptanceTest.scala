...
class VarLengthAcceptanceTest extends ExecutionEngineFunSuite with QueryStatisticsTestSupport with NewPlannerTestSupport {
  ...
  test("should handle LIKES*") {
    ...
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[r:LIKES*]->(c) RETURN r")
  ...
  test("should handle LIKES*0") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*0]->(c) RETURN c")
    //Then
  ...
  test("should handle LIKES*0..2") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*0..2]->(c) RETURN c")
    //Then
  ...
  test("should handle LIKES*..") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*..]->(c) RETURN c")
    //Then
    result.columnAs("c").toSet should be(generation(2) ++ generation(3) ++ generation(4))
  }
  ...
  test("should not accept LIKES..") {
    ...
    a[SyntaxException] should be thrownBy {
      executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES..]->(c) RETURN c")
    }
  }
  ...
  test("should handle LIKES*1") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*1]->(c) RETURN c")
    //Then
  ...
  test("should handle LIKES*1..2") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*1..2]->(c) RETURN c")
    //Then
  ...
  test("should handle LIKES*0..0") {
    ...
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*0..0]->(c) RETURN c")
    //Then
    result.columnAs("c").toSet should be(Set(nodes("n0")))
  }
  ...
  test("should handle LIKES*1..1") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*1..1]->(c) RETURN c")
    //Then
    result.columnAs("c").toSet should be(generation(2))
  }
  ...
  test("should handle LIKES*2..2") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*2..2]->(c) RETURN c")
    //Then
  ...
  test("should not return results for LIKES*2..1") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*2..1]->(c) RETURN c")
    //Then
  ...
  test("should handle LIKES*2") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode( "MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*2]->(c) RETURN c")
    //Then
    result.columnAs("c").toSet should be(generation(3))
  }
  ...
  test("should handle LIKES*..0") {
    ...
    makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode( "MATCH (p { id:'A' }) MATCH (p)-[:LIKES*..0]->(c) RETURN c")
    //Then
    result.columnAs("c").toSet should be(empty)
  }
  ...
  test("should handle LIKES*1..0") {
    ...
    makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode( "MATCH (p { id:'A' }) MATCH (p)-[:LIKES*1..0]->(c) RETURN c")
    //Then
    result.columnAs("c").toSet should be(empty)
  }
  ...
  test("should handle LIKES*0.LIKES") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*0]->()-[r:LIKES]->(c) RETURN c")
    //Then
  ...
  test("should handle LIKES.LIKES*0") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[r:LIKES*0]->(c) RETURN c")
    //Then
    result should haveNoneRelFilter
    result.columnAs("c").toSet should be(generation(2))
  }
  ...
  test("should handle LIKES*1.LIKES") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*1]->()-[r:LIKES]->(c) RETURN c")
    //Then
    result should haveNoneRelFilter
    result.columnAs("c").toSet should be(generation(3))
  }
  ...
  test("should handle LIKES.LIKES*1") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[r:LIKES*1]->(c) RETURN c")
    //Then
    result should haveNoneRelFilter
    result.columnAs("c").toSet should be(generation(3))
  }
  ...
  test("should handle LIKES*2.LIKES") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*2]->()-[r:LIKES]->(c) RETURN c")
    //Then
    result should haveNoneRelFilter
  ...
  test("should handle LIKES.LIKES*2") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 4)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[r:LIKES*2]->(c) RETURN c")
    //Then
    result should haveNoneRelFilter
    result.columnAs("c").toSet should be(generation(4))
  }
  ...
  test("should handle LIKES.LIKES*3") {
    ...
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[r:LIKES*3]->(c) RETURN c")
    //Then
    result should haveNoneRelFilter
  ...
  test("should handle LIKES*1.LIKES.LIKES*2") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 5)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES*1]->()-[:LIKES]->()-[r:LIKES*2]->(c) RETURN c")
    //Then
    result should haveNoneRelFilter
    result.columnAs("c").toSet should be(generation(5))
  }
  ...
  test("should handle LIKES.LIKES*2.LIKES") {
    ...
    implicit val nodes = makeTreeModel(maxNodeDepth = 5)
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH (p { id:'n0' }) MATCH (p)-[:LIKES]->()-[:LIKES*2]->()-[r:LIKES]->(c) RETURN c")
    //Then
    result should haveNoneRelFilter
    result.columnAs("c").toSet should be(generation(5))
  }
  ...
  test("should use variable of already matched rel in a varlenght path") {
    ...
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("""MATCH ()-[r:`EDGE`]-()
                                          |WITH r
  ...
  test("should handle all rel predicates") {
    ...
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH path=(p {id:'n0' })-[r:LIKES*]->(c) " +
  ...
  test("should handle all multiple rel predicates") {
    ...
    //When
    val result = executeWithAllPlannersAndRuntimesAndCompatibilityMode("MATCH path=(p {id:'n0' })-[:LIKES*..2]->(cc) " +
