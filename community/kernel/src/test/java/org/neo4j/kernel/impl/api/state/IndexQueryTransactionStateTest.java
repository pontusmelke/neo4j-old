...
public class IndexQueryTransactionStateTest
{
    ...
    public void before() throws Exception
    {
        ...
        when( store.indexGetReader( any( SchemaResources.class ), eq( indexDescriptor ) ) )
                .thenReturn( indexReader );
        when( store.indexGetFreshReader( any( SchemaResources.class ), eq( indexDescriptor ) ) )
                .thenReturn( indexReader );
    ...
    public void shouldExcludeRemovedNodesFromIndexQuery() throws Exception
    {
        ...
        when( store.nodeGetSingleCursor( eq( nodeId ), any( ReadableTransactionState.class ) ) )
    ...
    public void shouldExcludeChangedNodesWithMissingLabelFromIndexQuery() throws Exception
    {
        ...
        state.writableTxState().nodeDoAddProperty( 1L, propertyKeyId, Values.of( 10 ) );
    ...
    public void shouldIncludeCreatedNodesWithCorrectLabelAndProperty() throws Exception
    {
        ...
        state.writableTxState().nodeDoAddProperty( nodeId, propertyKeyId, value );
        when( store.nodeGetSingleCursor( eq( nodeId ), any( ReadableTransactionState.class ) ) )
    ...
    public void shouldExcludeNodesWithRemovedProperty() throws Exception
    {
        ...
        long nodeId = 1L;
        state.writableTxState().nodeDoAddProperty( nodeId, propertyKeyId, Values.of( 10 ) );
    ...
    private void mockStoreProperty()
    {
        ...
        when( store.nodeGetProperty( any( NodeItem.class ), eq( propertyKeyId ), any( PropertyContainerState.class ) ) )
                .thenReturn( asPropertyCursor( property( propertyKeyId, value.asPublic() ) ) );
    }
