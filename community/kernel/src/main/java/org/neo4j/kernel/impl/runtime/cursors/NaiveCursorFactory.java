...
public class NaiveCursorFactory implements CursorFactory
{
    ...
    {
        return new StateAwareRelationshipGroupCursor( new StateAwareRelationshipTraversalCursor() );
    }
